// =====================================================
// PEWC — Pacote único da Nurse Joy (itens válidos do proto)
// =====================================================
#include "global.h"
#include "scrcmd.h"
#include "data.h"
...
// 12 medicamentos — 10 unidades cada (IDs do ItemEnum.proto)
...
// 4 Poké Balls — 10 unidades cada (exclui Master Ball)
...
// 4 itens competitivos — 10 unidades cada
...
// Pacote único: entrega uma vez, sem reposição
